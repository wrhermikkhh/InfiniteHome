...
export const posTransactions = pgTable("pos_transactions", {
  ...
  deliveryStatusHistory: jsonb("delivery_status_history").$type<{ status: string; timestamp: string }[]>().default([]), // tracks delivery status changes with timestamps
...
export const orders = pgTable("orders", {
  ...
  boatAtollIsland: text("boat_atoll_island"), // Atoll and island for boat deliveries
