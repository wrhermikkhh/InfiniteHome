...
test("permission map protects management, uploads, customer-data and preserves public reads", () => {
  ...
  assert.equal(adminPermissionForRoute("/api/admin/quotations", "GET"), "canManageQuotations");
  assert.equal(adminPermissionForRoute("/api/admin/quotations/id", "PATCH"), "canManageQuotations");
  assert.equal(adminPermissionForRoute("/api/admin/purchase-orders", "GET"), "canManagePurchaseOrders");
  assert.equal(adminPermissionForRoute("/api/admin/purchase-orders/id", "PATCH"), "canManagePurchaseOrders");
  assert.equal(adminPermissionForRoute("/api/admin/accounting/reports", "GET"), "super");
  assert.equal(adminPermissionForRoute("/api/admins/id/permissions", "PATCH"), "super");
