...
export async function sendOrderLabelEmail(order: any) {
  try {
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #f0e6d2;">
          ...
          <div style="padding: 40px 30px;">
            <div style="text-align: center; margin-bottom: 30px;">
              ...
              <h2 style="color: #1a1a1a; font-size: 24px; margin: 0; font-family: serif;">Your Order Is Being Prepared</h2>
            </div>
            <p style="color: #333; line-height: 1.6;">Dear ${order.customerName},</p>
            <p style="color: #333; line-height: 1.6;">Great news! Your shipping label has been generated and your order is being prepared for dispatch. You can use your tracking number below to follow your package every step of the way.</p>

            <div style="margin: 30px 0; padding: 25px; background-color: #fcfaf7; border: 1px solid #f0e6d2; border-radius: 4px;">
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  <td style="padding-bottom: 12px; font-size: 14px; color: #666;">Order Number:</td>
                  <td style="padding-bottom: 12px; font-size: 14px; font-weight: 700; color: #1a1a1a; text-align: right; font-family: monospace;">${order.orderNumber}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding-top: 12px; border-top: 1px solid #f0e6d2; font-size: 14px; color: #666;">Shipping Address:</td>
                  <td style="padding-top: 12px; border-top: 1px solid #f0e6d2; font-size: 14px; color: #1a1a1a; text-align: right;">${order.shippingAddress || '—'}</td>
                </tr>
              </table>
              <div style="margin-top: 20px; text-align: center;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
              ...
              <tfoot>
                <tr>
                  ...
                  <td style="padding: 14px 8px; text-align: right; font-size: 16px; font-weight: bold; color: #1a1a1a; border-top: 1px solid #1a1a1a;">MVR ${(order.total || 0).toLocaleString()}</td>
                </tr>
              </tfoot>
            </table>
    ...
    await resend.emails.send({
      ...
      to: order.customerEmail,
      subject: `Shipping Label Created — Order ${order.orderNumber}`,
      html,
    });

    console.log(`Order label email sent to ${order.customerEmail} for order ${order.orderNumber} (tracking: ${trackingNumber})`);
  } catch (error) {
    console.error('Error sending order label email:', error);
  }
}
